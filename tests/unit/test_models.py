...
class TestScoreDistribution:
    ...
    def test_percentages(self, sample_score_distribution):
        ...
        percentages = {
            k: (v / total * 100) for k, v in sample_score_distribution.items()
        }
...
class TestAnimeData:
    ...
    def test_creation(self, sample_score_distribution):
        ...
        total = sum(sample_score_distribution.values())
        dist = ScoreDistribution(
            vote_counts=sample_score_distribution, total_votes=total
        )
    ...
    def test_optional_fields_defaults(self):
        ...
        anime = AnimeData(mal_id=1, title="Test", score=7.0, url="")
