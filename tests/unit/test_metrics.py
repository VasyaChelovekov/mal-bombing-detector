...
class TestMetricsCalculator:
    ...
    def normal_anime(self, normal_score_distribution):
        ...
        percentages = {k: (v / total * 100) for k, v in normal_score_distribution.items()}
    ...
    def bombed_anime(self, bombed_score_distribution):
        ...
        percentages = {k: (v / total * 100) for k, v in bombed_score_distribution.items()}
...
class TestMetricsCalculatorRanking:
    ...
    def test_rank_by_bombing_orders_correctly(
        ...
        normal_pct = {k: (v / normal_total * 100) for k, v in normal_score_distribution.items()}
        
        bombed_total = sum(bombed_score_distribution.values())
        bombed_pct = {k: (v / bombed_total * 100) for k, v in bombed_score_distribution.items()}
