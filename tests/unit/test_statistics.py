...
from src.core.statistics import DistributionStatistics, ZScoreCalculator, EffectSizeCalculator
...
class TestDistributionStatistics:
    ...
    def test_calculate_mean(self):
        ...
        distribution = {1: 10, 2: 10, 3: 10, 4: 10, 5: 10, 6: 10, 7: 10, 8: 10, 9: 10, 10: 10}
    ...
    def test_calculate_median(self):
        ...
        uniform = {1: 10, 2: 10, 3: 10, 4: 10, 5: 10, 6: 10, 7: 10, 8: 10, 9: 10, 10: 10}
    ...
    def test_calculate_normalized_entropy(self):
        ...
        concentrated = {10: 100}
        norm_entropy_conc = DistributionStatistics.calculate_normalized_entropy(concentrated)
...
class TestEffectSizeCalculator:
    ...
    def test_cohens_d_different(self):
        ...
        observed = {1: 40.0, 2: 5.0, 3: 5.0, 4: 5.0, 5: 5.0, 6: 10.0, 7: 10.0, 8: 10.0, 9: 5.0, 10: 5.0}
        # Expected is more uniform with peak at 8
        expected = {1: 2.0, 2: 3.0, 3: 5.0, 4: 8.0, 5: 10.0, 6: 15.0, 7: 20.0, 8: 22.0, 9: 10.0, 10: 5.0}
