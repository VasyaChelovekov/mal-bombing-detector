    ...
    def sample_anime_list(self):
        ...
        anime_list.append(
            AnimeData(
                ...
                distribution=ScoreDistribution(
                    vote_counts=normal_votes, percentages=normal_pct, total_votes=total
                ),
            )
        )
        ...
        anime_list.append(
            AnimeData(
                ...
                members=75000,
                distribution=ScoreDistribution(
                    vote_counts=polar_votes, percentages=polar_pct, total_votes=total_p
                ),
            )
        )
...
class TestMetricsCalculatorIntegration:
    ...
    def test_calculate_with_real_distribution(self):
        ...
        anime = AnimeData(
            ...
            url="",
            distribution=ScoreDistribution(
                vote_counts=votes, percentages=pct, total_votes=total
            ),
        )
