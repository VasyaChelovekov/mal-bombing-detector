...
class FileCache:
    ...
    def __init__(
        ...
        self.compression = (
            compression if compression is not None else config.cache.compression
        )
    ...
    def _evict_lru(self) -> None:
        ...
        while len(self._entries) > self.max_entries:
            # Find LRU entry
            lru_key = min(
                self._entries.keys(), key=lambda k: self._entries[k].accessed_at
            )
    ...
    def stats(self) -> Dict[str, Any]:
        ...
        return {
            ...
            "file_size_bytes": self._cache_file.stat().st_size
