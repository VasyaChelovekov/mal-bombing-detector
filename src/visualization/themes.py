...
# Predefined themes
DEFAULT_THEME = Theme(name="default", palette=ColorPalette())

DARK_THEME = Theme(
    name="dark",
    palette=ColorPalette(
        background="#1e1e1e", grid="#404040", text="#ffffff", text_secondary="#aaaaaa"
    ),
...
SEABORN_THEME = Theme(
    name="seaborn",
    palette=ColorPalette(
        primary="#4c72b0", secondary="#55a868", danger="#c44e52", warning="#ccb974"
    ),
...
MINIMAL_THEME = Theme(
    name="minimal",
    palette=ColorPalette(primary="#333333", secondary="#666666"),
